...
import testDocsMenu from '../components/testDocsMenu';
import {htmlToReact, getPages, Link, safePrefix} from '../utils';

export default class testDocs extends React.Component {
    render() {
              ...
              <div className="outer">
                <div className="inner">
                  <div className="docs-content">
                    <testDocsMenu {...this.props} page={this.props.pageContext} site={this.props.pageContext.site} />
